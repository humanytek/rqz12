...
def post_init_hook(cr, registry):
    url_dir = 'http://www.sat.gob.mx/sitio_internet/cfd/valesdedespensa/valesdedespensa.xsd' # noqa
    name_s = 'http://www.sat.gob.mx/valesdedespensa'
    _load_xsd_complement(cr, registry, url_dir, name_s)


def _load_xsd_complement(cr, registry, url_dir, name_s):
